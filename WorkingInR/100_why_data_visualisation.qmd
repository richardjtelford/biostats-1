...
We will focus this tutorial on `ggplot2` [@Wickham2023-yw] and associated R packages, as it is generally easier to make nice figures in `ggplot2` than the others.
...
#| fig-alt: Drawing of a graph being painted on an easel.
